...
= 2.3 =
* Fixed place order showing up even there is no courier selected.
* Upgrade calculator showing up in bullet or dropdown form.
...
= 2.5 =
* Fixed order details sync price.

= 2.5 =
* Fixed order date save in database.
